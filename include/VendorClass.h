...
class VendorClass
{
    ...
    virtual void AddBus(BusDetails obj); // Function for adding buses by the vendor

    virtual void OccupySeat(int, int); // Occupying seat in the bus
    virtual void FreeSeat(int, int); // Freeing up a seat in the bus
    virtual bool CheckSeat(int, int); // Checking whether the seat is booked or not

    virtual int BusList()=0; // Virtual function that will be defined in the inherited reservation class
